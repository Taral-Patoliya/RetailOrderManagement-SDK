...
use Radial\RetailOrderManagement\Payload\TNoSet;
use Psr\Log\LoggerInterface;

/**
 * Order line item in a checkout inventory API inventory details request or allocation request.
 */
class CompliantShippingItem extends ShippingItem implements IShippingItem
{
    use TNoSet {
        TNoSet::setNull as setShippingMethodDisplayText;
        TNoSet::setNull as setShippingMethodMode;
    }
    /**
