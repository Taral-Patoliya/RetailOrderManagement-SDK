...
class QuantityItemIterable extends SPLObjectStorage implements IQuantityItemIterable
{
    use TIterablePayload;

    const SUBPAYLOAD_XPATH = '*';
    ...
    public function __construct(
        ...
        // This payload does not have a root node, it's elements
    ...
    {
        return $this->buildPayloadForInterface(static::QUANTITY_ITEM_INTERFACE);
    }

    protected function getNewSubpayload()
    {
        return $this->getEmptyQuantityItem();
    }
