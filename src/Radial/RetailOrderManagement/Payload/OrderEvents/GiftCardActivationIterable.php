...
class GiftCardActivationIterable extends SPLObjectStorage implements IGiftCardActivationIterable
{
    use TIterablePayload;

    const SUBPAYLOAD_XPATH = 'x:GiftCertificate';
    ...
    {
        return $this->getEmptyGiftCardActivation();
    }
