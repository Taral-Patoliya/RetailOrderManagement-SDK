...
class TaxChargeIterable extends SPLObjectStorage implements ITaxChargeIterable
{
    use TIterablePayload;

    const ROOT_NODE = '';
    const SUBPAYLOAD_XPATH = 'x:TaxCharge';
    ...
    /**
     * @see ITaxChargeIterable::getEmptyTaxCharge()
     */
    public function getEmptyTaxCharge()
    {
        return $this->buildPayloadForInterface(static::TAX_CHARGE_INTERFACE);
    }

    /**
     * Get a new order tax charge instance.
     * @return ITaxCharge
     */
    protected function getNewSubpayload()
    {
        return $this->getEmptyTaxCharge();
    }
