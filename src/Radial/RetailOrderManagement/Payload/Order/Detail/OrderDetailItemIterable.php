...
class OrderDetailItemIterable extends SPLObjectStorage implements IOrderDetailItemIterable
{
    ...
    /**
     * @see IOrderDetailItemIterable::getEmptyExchangeOrder()
     */
    public function getEmptyOrderDetailItem()
    {
        return $this->buildPayloadForInterface(static::ORDER_DETAIL_ITEM_INTERFACE);
    }

    /**
     * Get a new order detail item instance.
     *
     * @return IOrderDetailItem
     */
    protected function getNewSubpayload()
    {
        return $this->getEmptyOrderDetailItem();
    }
