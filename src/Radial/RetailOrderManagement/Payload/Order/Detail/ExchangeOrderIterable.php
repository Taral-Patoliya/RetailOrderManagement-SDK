...
class ExchangeOrderIterable extends SPLObjectStorage implements IExchangeOrderIterable
{
    ...
    const ROOT_NODE = 'ExchangeOrders';
    const SUBPAYLOAD_XPATH = 'x:ExchangeOrder';
    ...
    /**
     * @see IExchangeOrderIterable::getEmptyExchangeOrder()
     */
    public function getEmptyExchangeOrder()
    {
        return $this->buildPayloadForInterface(static::EXCHANGE_ORDER_INTERFACE);
    }

    /**
     * Get a new order exchange order instance.
     * @return IExchangeOrder
     */
    protected function getNewSubpayload()
    {
        return $this->getEmptyExchangeOrder();
    }
