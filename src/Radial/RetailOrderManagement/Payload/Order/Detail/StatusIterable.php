...
class StatusIterable extends SPLObjectStorage implements IStatusIterable
{
    use TIterablePayload;

    const ROOT_NODE = 'Statuses';
    const SUBPAYLOAD_XPATH = 'x:Status';
    ...
    /**
     * @see IStatusIterable::getEmptyStatus()
     */
    public function getEmptyStatus()
    {
        return $this->buildPayloadForInterface(static::STATUS_INTERFACE);
    }
