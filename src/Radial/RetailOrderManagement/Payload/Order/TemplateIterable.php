...
class TemplateIterable extends SPLObjectStorage implements ITemplateIterable
{
    use TIterablePayload;

    const SUBPAYLOAD_XPATH = 'x:Template';
    const ROOT_NODE = 'Templates';
    ...
    {
        return $this->buildPayloadForInterface(static::TEMPLATE_INTERFACE);
    }
