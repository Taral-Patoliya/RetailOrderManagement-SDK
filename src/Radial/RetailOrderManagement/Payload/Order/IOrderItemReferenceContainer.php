...
interface IOrderItemReferenceContainer
{
    const ITEM_REFERENCE_ITERABLE_INTERFACE =
     ...
     * @return self
     */
    public function setItemReferences(IOrderItemReferenceIterable $itemReferences);
}
