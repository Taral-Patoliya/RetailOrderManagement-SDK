...
interface ITaxedCustomizationIterable extends \Countable, \Iterator, \ArrayAccess, IPayload
{
    const CUSTOMIZATION_INTERFACE =
        '\Radial\RetailOrderManagement\Payload\TaxDutyFee\ITaxedCustomization';
    const XML_NS = 'http://api.gsicommerce.com/schema/checkout/1.0';

    /**
     * Get a new, empty customization object.
     *
