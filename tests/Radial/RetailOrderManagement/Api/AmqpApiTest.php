...
class AmqpApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->config = $this->getMockBuilder('\Radial\RetailOrderManagement\Api\IAmqpConfig')
    ...
    public function testConnect()
    {
        ...
        $amqpApi = $this->getMockBuilder('\Radial\RetailOrderManagement\Api\AmqpApi')
    ...
    {
        /** @var \Radial\RetailOrderManagement\Api\AmqpApi $amqpApi */
        $amqpApi = $this->getMock(
            '\Radial\RetailOrderManagement\Api\AmqpApi',
    ...
    public function testOpenConnectionFailure()
    {
        ...
        $this->setExpectedException('\Radial\RetailOrderManagement\Api\Exception\ConnectionError');
