...
class QuantityRequestTest extends \PHPUnit_Framework_TestCase
{
    use TPayloadTest;
    ...
    {
        return [
            [__DIR__ . '/Fixtures/QuantityRequest.xml'],
        ];
    }
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Inventory\QuantityRequest');
    }
}
