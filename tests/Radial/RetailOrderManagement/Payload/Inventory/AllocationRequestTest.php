...
class AllocationRequestTest extends \PHPUnit_Framework_TestCase
{
    use TPayloadTest;
    ...
    {
        return [
            [__DIR__ . '/Fixtures/AllocationRequest.xml'],
        ];
    }
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Inventory\AllocationRequest');
    }
}
