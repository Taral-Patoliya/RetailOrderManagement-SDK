...
class ValidatorIteratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstruct()
    {
        ...
        self::$validator = $this->getMock('\Radial\RetailOrderManagement\Payload\IValidator');
    ...
    {
        $threeValidator = $this->getMock('Radial\RetailOrderManagement\Payload\IValidator');
        $fooValidator = $this->getMock('Radial\RetailOrderManagement\Payload\IValidator');
