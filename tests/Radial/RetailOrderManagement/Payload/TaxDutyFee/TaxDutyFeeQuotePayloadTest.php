...
class TaxDutyFeeQuotePayloadTest extends \PHPUnit_Framework_TestCase
{
    ...
    const REQUEST = '\Radial\RetailOrderManagement\Payload\TaxDutyFee\TaxDutyFeeQuoteRequest';
    const REPLY = '\Radial\RetailOrderManagement\Payload\TaxDutyFee\TaxDutyFeeQuoteReply';
