...
class AmqpPayloadIteratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @var \Radial\RetailOrderManagement\Api\IAmqpApi */
    protected $api;
    ...
    public function setUp()
    {
        ...
        $this->api = $this->getMockBuilder('\Radial\RetailOrderManagement\Api\IAmqpApi')
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        // stub an IOrderEvent payload to be returned from the message factory
        $this->payload = $this->getMockBuilder('\Radial\RetailOrderManagement\Payload\IPayload')
            ->disableOriginalConstructor()
        ...
        $this->messageFactory = $this->getMockBuilder('\Radial\RetailOrderManagement\Payload\IMessageFactory')
            ->getMockForAbstractClass();
