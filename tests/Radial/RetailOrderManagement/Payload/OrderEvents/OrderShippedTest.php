...
class OrderShippedTest extends \PHPUnit_Framework_TestCase
{
    /** @var PayloadFactory */
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\OrderEvents\OrderShipped', null, null, new NullLogger());
    }
    ...
    {
        return [
            [__DIR__ . '/Fixtures/OrderShipped.xml'],
            [__DIR__ . '/Fixtures/OrderShippedStoreLocation.xml'],
            [__DIR__ . '/Fixtures/OrderShippedMinimalData.xml'],
        ];
    }
