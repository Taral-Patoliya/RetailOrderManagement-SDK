...
class OrderConfirmedTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\OrderEvents\OrderConfirmed', null, null, new NullLogger());
    }
    ...
    {
        return [
            [__DIR__ . '/Fixtures/OrderConfirmed.xml'],
            [__DIR__ . '/Fixtures/OrderConfirmedMinimalData.xml'],
        ];
    }
