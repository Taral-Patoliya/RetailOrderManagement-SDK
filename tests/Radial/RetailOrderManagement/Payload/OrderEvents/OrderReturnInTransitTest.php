...
class OrderReturnInTransitTest extends \PHPUnit_Framework_TestCase
{
    /** @var PayloadFactory */
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\OrderEvents\OrderReturnInTransit', null, null, new NullLogger());
    }
    ...
    {
        return [
            [__DIR__ . '/Fixtures/OrderReturnInTransit.xml'],
        ];
    }
