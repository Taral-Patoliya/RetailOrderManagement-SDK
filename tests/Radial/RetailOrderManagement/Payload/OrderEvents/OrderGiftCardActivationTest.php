...
{
    const PAYLOAD_CLASS =
        '\Radial\RetailOrderManagement\Payload\OrderEvents\OrderGiftCardActivation';
    /** @var PayloadFactory */
    ...
    {
        return [
            [__DIR__ . '/Fixtures/OrderGiftCardActivation.xml'],
            [__DIR__ . '/Fixtures/OrderGiftCardActivationMinimalData.xml'],
        ];
    }
