...
class OrderPriceAdjustmentTest extends \PHPUnit_Framework_TestCase
{
    /** @var PayloadFactory */
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\OrderEvents\OrderPriceAdjustment', null, null, new NullLogger());
    }
    ...
    {
        return [
            [__DIR__ . '/Fixtures/OrderPriceAdjustment.xml'],
            [__DIR__ . '/Fixtures/OrderPriceAdjustmentMinimalData.xml'],
        ];
    }
