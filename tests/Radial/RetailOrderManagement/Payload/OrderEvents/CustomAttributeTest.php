...
class CustomAttributeTest extends \PHPUnit_Framework_TestCase
{
    ...
    const FULL_FIXTURE_FILE = 'CustomAttribute.xml';
    ...
    public function setUp()
    {
        ...
        $this->fullPayload = $this->buildPayload(['setKey' => 'the key', 'setValue' => 'the value']);
    }

    /**
     * Get a new CustomAttribute payload. Each payload will contain a
    ...
    {
        return new CustomAttribute($this->validatorIterator, $this->stubSchemaValidator, $this->payloadMap, new NullLogger());
    }
