...
class OrderDetailRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Order\Detail\OrderDetailRequest', null, null, new NullLogger());
    }
     ...
     * @return array
     */
    public function provideOrderDetailRequestSerializedDataFile()
    {
        return [
            [__DIR__ . '/Fixtures/OrderDetailRequest.xml'],
            [__DIR__ . '/Fixtures/OrderDetailRequestMinimalData.xml'],
        ];
    }
     ...
     * @dataProvider provideOrderDetailRequestSerializedDataFile
     */
    public function testOrderDetailRequestDeserializeSerialize($serializedDataFile)
    {
