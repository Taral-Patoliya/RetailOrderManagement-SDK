...
class PriceGroupTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideSerializedDataFile()
    {
        return [
            [
                __DIR__ . '/Fixtures/PriceGroup.xml'
            ],
        ];
    }
    ...
    /**
     * Get a new PriceGroup payload.
     * @return PriceGroup
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Order\PriceGroup', null, null, new NullLogger());
    }
}
