...
class OrderCancelResponseTest extends \PHPUnit_Framework_TestCase
{
    /** @var PayloadFactory */
    ...
    /**
     * Create a new OrderCancelResponse payload.
     *
     * @return IPayload
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Order\OrderCancelResponse', null, null, new NullLogger());
    }
     ...
     * @return array
     */
    public function provideOrderCancelResponseSerializedDataFile()
    {
        return [
            [__DIR__ . '/Fixtures/OrderCancelResponse.xml'],
        ];
    }
     ...
     * @dataProvider provideOrderCancelResponseSerializedDataFile
     */
    public function testOrderCancelResponseDeserializeSerialize($serializedDataFile)
    {
