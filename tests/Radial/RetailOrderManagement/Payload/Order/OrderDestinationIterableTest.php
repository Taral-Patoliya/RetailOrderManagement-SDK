...
class OrderDestinationIterableTest extends \PHPUnit_Framework_TestCase
{
    use TPayloadTest;
    ...
    public function provideSerializedDataFile()
    {
        return [
            [
                __DIR__ . '/Fixtures/OrderDestinationIterable.xml'
            ],
        ];
    }
    ...
    /**
     * Get a new OrderDestinationIterable payload.
     * @return OrderDestinationIterable
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Order\OrderDestinationIterable', null, null, new NullLogger());
    }
}
