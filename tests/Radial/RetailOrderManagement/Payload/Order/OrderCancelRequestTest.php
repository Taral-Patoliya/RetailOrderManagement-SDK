...
class OrderCancelRequestTest extends \PHPUnit_Framework_TestCase
{
    /** @var PayloadFactory */
    ...
    /**
     * Create a new OrderCancelRequest payload.
     *
     * @return IPayload
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Order\OrderCancelRequest', null, null, new NullLogger());
    }
     ...
     * @return array
     */
    public function provideOrderCancelRequestSerializedDataFile()
    {
        return [
            [__DIR__ . '/Fixtures/OrderCancelRequest.xml'],
            [__DIR__ . '/Fixtures/OrderCancelRequestMinimalData.xml'],
        ];
    }
     ...
     * @dataProvider provideOrderCancelRequestSerializedDataFile
     */
    public function testOrderCancelRequestDeserializeSerialize($serializedDataFile)
    {
