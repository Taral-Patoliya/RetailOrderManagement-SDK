...
class TenderTypeLookupRequestTest extends \PHPUnit_Framework_TestCase
{
    use TPayloadTest;
    ...
    {
        return [
            [__DIR__ . '/Fixtures/tendertypelookuprequest.xml'],
            [__DIR__ . '/Fixtures/tendertypelookuprequest-encrypted.xml'],
        ];
    }
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Payment\TenderType\LookupRequest');
    }
}
