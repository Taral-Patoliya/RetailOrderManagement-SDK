...
class PayPalGetExpressCheckoutReplyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideSerializedDataFile()
    {
        return [
            [
                __DIR__ . '/Fixtures/PayPalGetExpressCheckoutReplyTest.xml'
            ]
        ];
    }
    ...
    /**
     * Get a new PayPalGetExpressCheckoutReply payload.
     * @return PayPalGetExpressCheckoutReply
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Payment\PayPalGetExpressCheckoutReply', null, null, new NullLogger());
    }
}
