...
class PayPalDoExpressCheckoutReplyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideSerializedDataFile()
    {
        return [
            [
                __DIR__ . '/Fixtures/PayPalDoExpressCheckoutReplyTest.xml'
            ]
        ];
    }
    ...
    /**
     * Get a new PayPalDoExpressCheckoutReply payload.
     * @return PayPalDoExpressCheckoutReply
     */
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Payment\PayPalDoExpressCheckoutReply', null, null, new NullLogger());
    }
}
