 ...
 *
 * Tests that the payload object for StoredValueRedeemRequest contains
...
class StoredValueRedeemRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Payment\StoredValueRedeemRequest', null, null, new NullLogger());
    }
