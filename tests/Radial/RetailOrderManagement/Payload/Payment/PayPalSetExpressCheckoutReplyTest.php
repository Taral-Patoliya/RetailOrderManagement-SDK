...
class PayPalSetExpressCheckoutReplyTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideSerializedDataFile()
    {
        return [
            [
                __DIR__ . "/Fixtures/PayPalSetExpressCheckoutReplyTest.xml"
            ]
        ];
    }
    ...
    protected function createNewPayload()
    {
        return $this->payloadFactory
            ->buildPayload('\Radial\RetailOrderManagement\Payload\Payment\PayPalSetExpressCheckoutReply', null, null, new NullLogger());
    }
}
